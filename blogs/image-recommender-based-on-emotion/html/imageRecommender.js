...
userButton.addEventListener("click", emotion);
nextButton.addEventListener("click", userRecommendation);
...
function drawGallery(emotionValue) {
    const url = "gallery";
    const xhr = new XMLHttpRequest();
